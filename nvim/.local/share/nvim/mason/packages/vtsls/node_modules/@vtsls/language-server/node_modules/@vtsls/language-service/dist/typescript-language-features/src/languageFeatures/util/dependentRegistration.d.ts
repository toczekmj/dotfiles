...
export declare function conditionalRegistration(conditions: readonly Condition[], doRegister: () => vscode.Disposable, elseDoRegister?: () => vscode.Disposable): vscode.Disposable;
...
export declare function requireHasVsCodeExtension(extensionId: string): Condition;
