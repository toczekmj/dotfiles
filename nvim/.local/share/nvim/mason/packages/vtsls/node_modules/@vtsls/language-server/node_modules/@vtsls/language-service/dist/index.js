...
var DisposableStore2;
var init_dispose2 = __esm({
  "src/utils/dispose.ts"() {
    "use strict";
    init_cjs_shims();
    init_dispose();
    DisposableStore2 = class _DisposableStore {
...
var init_commands = __esm({
  "src/shims/commands.ts"() {
    ...
    CommandsShimService = class extends Disposable {
      ...
      _onDidRegisterCommand = this._register(new lsp2.Emitter());
...
var init_lazy = __esm({
  "src/typescript-language-features/src/utils/lazy.ts"() {
    ...
    Lazy = class _Lazy {
      ...
      map(fn) {
        return new _Lazy(() => fn(this.value));
      }
    };
  }
});
...
function isWeb() {
  return !(typeof process === "object" && !!process.versions.node) && env.uiKind === 2 /* Web */;
}
...
var file, untitled, git, github, azurerepos, chatEditingTextModel, vsls, walkThroughSnippet, vscodeNotebookCell, officeScript, chatCodeBlock, zipfile, disabledSchemes;
var init_fileSchemes = __esm({
  "src/typescript-language-features/src/configuration/fileSchemes.ts"() {
    ...
    chatEditingTextModel = "chat-editing-text-model";
    vsls = "vsls";
...
var init_diagnostics = __esm({
  "src/shims/diagnostics.ts"() {
    ...
    DiagnosticsShimService = class extends Disposable {
      diagnosticsCollections = /* @__PURE__ */ new Map();
      onDidChangeDiagnostics = this._register(
...
var init_languageFeatures = __esm({
  "src/shims/languageFeatures.ts"() {
    ...
    LanguageFeaturesRegistryStore = class extends Disposable {
      callHierarchy = this._register(
        new LanguageFeatureRegistry("callHierarchy")
      );
      codeActions = this._register(new CodeActionProviderRegistry());
      codeLens = this._register(
        new LanguageFeatureRegistry("codeLens")
      );
      completionItem = this._register(new CompletionProviderRegistry());
      declaration = this._register(
        new LanguageFeatureRegistry("declaration")
      );
      definition = this._register(
      ...
      documentHighlight = this._register(
        new LanguageFeatureRegistry("documentHighlight")
      );
      documentLink = this._register(
        new LanguageFeatureRegistry("documentLink")
      );
      documentRangeFormattingEdit = this._register(
      ...
      typeDefinition = this._register(
        new LanguageFeatureRegistry("typeDefinition")
      );
      typeHierarchy = this._register(
        new LanguageFeatureRegistry("typeHierarchy")
      );
      workspaceSymbol = this._register(
    ...
    LanguageFeaturesShimService = class extends Disposable {
      ...
      _registryStore = this._register(new LanguageFeaturesRegistryStore());
...
var import_vscode_uri4, Disposable4, Position, Range, Selection, TextEdit, SnippetTextEdit, WorkspaceEdit, SnippetString, DiagnosticSeverity, Location, DiagnosticRelatedInformation, Diagnostic, Hover, VerboseHover, DocumentHighlightKind, DocumentHighlight, MultiDocumentHighlight, SymbolKind, SymbolInformation, DocumentSymbol, CodeAction, CodeActionKind, SelectionRange, CallHierarchyItem, CallHierarchyIncomingCall, CallHierarchyOutgoingCall, CodeLens, BaseMarkdownString, MarkdownString, ParameterInformation, SignatureInformation, SignatureHelp, InlayHintLabelPart, InlayHint, CompletionItemKind, CompletionItem, CompletionList, TextEditorSelectionChangeKind, DataTransferItem, DocumentDropOrPasteEditKind, DocumentPasteEdit, RelativePattern, FoldingRange, SemanticTokensLegend, SemanticTokensBuilder, SemanticTokens, LinkedEditingRanges, TabInputText, TabInputTextDiff, TabInputNotebook, CancellationError;
  ...
  "src/shims/types.ts"() {
    ...
    DocumentSymbol = class _DocumentSymbol {
      static validate(candidate) {
        ...
        candidate.children?.forEach(_DocumentSymbol.validate);
      }
      name;
      detail;
      kind;
    ...
    DocumentDropOrPasteEditKind = class _DocumentDropOrPasteEditKind {
      constructor(value) {
        this.value = value;
      }
      static Empty;
...
var init_log = __esm({
  "src/shims/log.ts"() {
    ...
    LogOutputChannel = class extends OutputChannel {
      logLevel = 1 /* Trace */;
      _onDidChangeLogLevel = new lsp4.Emitter();
...
var init_window = __esm({
  "src/shims/window.ts"() {
    ...
    WindowShimService = class extends Disposable {
      ...
      outputChannels = /* @__PURE__ */ new Map();
      _onDidChangeActiveTextEditor = this._register(new lsp5.Emitter());
      onDidChangeActiveTextEditor = this._onDidChangeActiveTextEditor.event;
      _onDidChangeVisibleTextEditors = this._register(new lsp5.Emitter());
      onDidChangeVisibleTextEditors = this._onDidChangeVisibleTextEditors.event;
      _onDidChangeTabGroups = this._register(new lsp5.Emitter());
      _onDidChangeTabs = this._register(new lsp5.Emitter());
      tabGroups = {
      ...
      async _showMessagePrompt(type, message, items) {
        ...
        if (selected?.tsId !== void 0 && typeof selected.tsId === "number") {
...
// src/typescript-language-features/src/commands/useTsgo.ts
async function updateTsgoSetting(enable) {
  const tsgoExtension = extensions.getExtension(tsNativeExtensionId);
  if (!tsgoExtension) {
    ...
    if (selection) {
      await env.openExternal(Uri.parse("https://github.com/microsoft/typescript-go"));
    }
  }
  ...
  if (inspect?.workspaceValue !== void 0) {
    ...
    const tsgoConfig = workspace.getConfiguration("typescript-go");
    const tsgoInspect = tsgoConfig.inspect("executablePath");
    if (tsgoInspect?.workspaceValue !== void 0) {
      target = 2 /* Workspace */;
    } else if (tsgoInspect?.workspaceFolderValue !== void 0) {
      target = 3 /* WorkspaceFolder */;
    }
  }
  await tsConfig.update("experimental.useTsgo", enable, target);
}
var tsNativeExtensionId, EnableTsgoCommand, DisableTsgoCommand;
var init_useTsgo = __esm({
  "src/typescript-language-features/src/commands/useTsgo.ts"() {
    "use strict";
    init_cjs_shims();
    init_shims();
    tsNativeExtensionId = "typescriptteam.native-preview";
    EnableTsgoCommand = class {
      id = "typescript.experimental.enableTsgo";
      async execute() {
        await updateTsgoSetting(true);
      }
    };
    DisableTsgoCommand = class {
...
var init_api2 = __esm({
  "src/typescript-language-features/src/tsServer/api.ts"() {
    ...
    API = class _API {
      ...
      static defaultVersion = _API.fromSimpleString("1.0.0");
      static v380 = _API.fromSimpleString("3.8.0");
      static v390 = _API.fromSimpleString("3.9.0");
      static v400 = _API.fromSimpleString("4.0.0");
      static v401 = _API.fromSimpleString("4.0.1");
      static v420 = _API.fromSimpleString("4.2.0");
      static v430 = _API.fromSimpleString("4.3.0");
      static v440 = _API.fromSimpleString("4.4.0");
      static v460 = _API.fromSimpleString("4.6.0");
      static v470 = _API.fromSimpleString("4.7.0");
      static v490 = _API.fromSimpleString("4.9.0");
      static v500 = _API.fromSimpleString("5.0.0");
      static v510 = _API.fromSimpleString("5.1.0");
      static v520 = _API.fromSimpleString("5.2.0");
      static v544 = _API.fromSimpleString("5.4.4");
      static v540 = _API.fromSimpleString("5.4.0");
      static v560 = _API.fromSimpleString("5.6.0");
      static v570 = _API.fromSimpleString("5.7.0");
      static v590 = _API.fromSimpleString("5.9.0");
...
async function openOrCreateConfig(version, projectType, rootPath, configuration) {
  ...
  const col = window.activeTextEditor?.viewColumn;
  try {
...
async function openProjectConfigOrPromptToCreate(projectType, client, rootPath, configFilePath) {
  if (!isImplicitProjectConfigFile(configFilePath)) {
    ...
    window.showTextDocument(doc, window.activeTextEditor?.viewColumn);
    return;
  }
...
var LearnMoreAboutRefactoringsCommand;
var init_learnMoreAboutRefactorings = __esm({
  "src/typescript-language-features/src/commands/learnMoreAboutRefactorings.ts"() {
    ...
    init_shims();
    init_languageIds();
    LearnMoreAboutRefactoringsCommand = class _LearnMoreAboutRefactoringsCommand {
      static id = "_typescript.learnMoreAboutRefactorings";
      id = _LearnMoreAboutRefactoringsCommand.id;
      execute() {
...
var OpenJsDocLinkCommand;
var init_openJsDocLink = __esm({
  "src/typescript-language-features/src/commands/openJsDocLink.ts"() {
    "use strict";
    init_cjs_shims();
    init_shims();
    OpenJsDocLinkCommand = class _OpenJsDocLinkCommand {
      static id = "_typescript.openJsDocLink";
      id = _OpenJsDocLinkCommand.id;
      async execute(args) {
...
var SelectTypeScriptVersionCommand;
var init_selectTypeScriptVersion = __esm({
  "src/typescript-language-features/src/commands/selectTypeScriptVersion.ts"() {
    "use strict";
    init_cjs_shims();
    SelectTypeScriptVersionCommand = class _SelectTypeScriptVersionCommand {
      constructor(lazyClientHost) {
        this.lazyClientHost = lazyClientHost;
      }
      static id = "typescript.selectTypeScriptVersion";
      id = _SelectTypeScriptVersionCommand.id;
      execute() {
    ...
    TSServerRequestCommand = class {
      ...
      async execute(command, args, config3, token) {
        ...
        if (args && typeof args === "object" && !Array.isArray(args)) {
          ...
          const hasFile = requestArgs.file instanceof Uri;
          const hasTraceId = typeof requestArgs.$traceId === "string";
          if (hasFile || hasTraceId) {
            const newArgs = { file: void 0, ...args };
            if (hasFile) {
...
var path3, RelativeWorkspacePathResolver;
        ...
        for (const root of workspace.workspaceFolders || []) {
          ...
          for (const rootPrefix of rootPrefixes) {
            if (relativePath.startsWith(rootPrefix)) {
              return path3.join(root.uri.fsPath, relativePath.replace(rootPrefix, ""));
            }
          }
        }
        return void 0;
...
var os3, path4, child_process, fs3, ElectronServiceConfigurationProvider;
  ...
  "src/typescript-language-features/src/configuration/configuration.electron.ts"() {
    ...
    ElectronServiceConfigurationProvider = class extends BaseServiceConfigurationProvider {
      fixPathPrefixes(inspectValue) {
        const pathPrefixes = ["~" + path4.sep];
        for (const pathPrefix of pathPrefixes) {
          if (inspectValue.startsWith(pathPrefix)) {
            return path4.join(os3.homedir(), inspectValue.slice(pathPrefix.length));
          }
        }
        return inspectValue;
      }
      ...
      validatePath(nodePath) {
        if (nodePath && (!fs3.existsSync(nodePath) || fs3.lstatSync(nodePath).isDirectory())) {
...
var path5, FileConfigurationManager, InlayHintSettingNames;
  ...
  "src/typescript-language-features/src/languageFeatures/fileConfigurationManager.ts"() {
    ...
    FileConfigurationManager = class extends Disposable {
      ...
      async ensureConfigurationForDocument(document2, token) {
        return this.ensureConfigurationOptions(document2, void 0, token);
      }
      getFormattingOptions(document2) {
        const editor = window.visibleTextEditors.find((editor2) => editor2.document.uri.toString() === document2.uri.toString());
        if (!editor) {
          return void 0;
        }
        return {
      ...
      getPreferences(document2) {
        ...
        const preferences = {
          ...
          providePrefixAndSuffixTextForRename: preferencesConfig.get("useAliasesForRenames", true),
          ...
          autoImportFileExcludePatterns: this.getAutoImportFileExcludePatternsPreference(preferencesConfig, workspace.getWorkspaceFolder(document2.uri)?.uri),
          ...
          maximumHoverLength: this.getMaximumHoverLength(document2)
        };
        return preferences;
      }
      ...
      getAutoImportFileExcludePatternsPreference(config3, workspaceFolder) {
        return workspaceFolder && config3.get("autoImportFileExcludePatterns")?.map((p) => {
          const isRelative = /^\.\.?($|[\/\\])/.test(p);
          const wildcardPrefix = this.client.apiVersion.gte(API.v540) ? "" : path5.parse(this.client.toTsFilePath(workspaceFolder)).root;
          return path5.isAbsolute(p) ? p : p.startsWith("*") ? wildcardPrefix + p : isRelative ? this.client.toTsFilePath(Uri.joinPath(workspaceFolder, p)) : wildcardPrefix + "**" + path5.sep + p;
        });
      }
      ...
      getMaximumHoverLength(document2) {
        const defaultMaxLength = 500;
        const maximumHoverLength = workspace.getConfiguration("js/ts", document2).get("hover.maximumLength", defaultMaxLength);
    ...
    InlayHintSettingNames = class {
      static parameterNamesSuppressWhenArgumentMatchesName = "inlayHints.parameterNames.suppressWhenArgumentMatchesName";
      static parameterNamesEnabled = "inlayHints.parameterTypes.enabled";
      static variableTypesEnabled = "inlayHints.variableTypes.enabled";
      static variableTypesSuppressWhenTypeMatchesName = "inlayHints.variableTypes.suppressWhenTypeMatchesName";
      static propertyDeclarationTypesEnabled = "inlayHints.propertyDeclarationTypes.enabled";
      static functionLikeReturnTypesEnabled = "inlayHints.functionLikeReturnTypes.enabled";
      static enumMemberValuesEnabled = "inlayHints.enumMemberValues.enabled";
    };
  }
});
...
var FileDiagnostics, DiagnosticSettings, DiagnosticsTelemetryManager, DiagnosticsManager;
var init_diagnostics2 = __esm({
  "src/typescript-language-features/src/languageFeatures/diagnostics.ts"() {
    ...
    DiagnosticSettings = class _DiagnosticSettings {
      static defaultSettings = {
        validate: true,
        enableSuggestions: true
      };
      _languageSettings = /* @__PURE__ */ new Map();
    ...
    DiagnosticsTelemetryManager = class extends Disposable {
      ...
      _diagnosticCodesMap = /* @__PURE__ */ new Map();
      _diagnosticSnapshotsMap = new ResourceMap((uri) => uri.toString(), { onCaseInsensitiveFileSystem: false });
      _timeout;
      _telemetryEmitter;
      ...
      _updateDiagnosticCodes() {
        this._diagnosticsCollection.forEach((uri, diagnostics) => {
          ...
          const diagnosticsDiff = diagnostics.filter((diagnostic) => !previousDiagnostics?.some((previousDiagnostic) => equals2(diagnostic, previousDiagnostic)));
...
var init_typescriptService = __esm({
  "src/typescript-language-features/src/typescriptService.ts"() {
    ...
    ((ServerResponse4) => {
      ...
      ServerResponse4.Cancelled = Cancelled;
      ServerResponse4.NoContent = { type: "noContent" };
      ServerResponse4.NoServer = { type: "noServer" };
...
var Kind, DiagnosticCategory, KindModifiers, DisplayPartKind;
var init_protocol_const = __esm({
  "src/typescript-language-features/src/tsServer/protocol/protocol.const.ts"() {
    ...
    KindModifiers = class _KindModifiers {
...
var init_dependentRegistration = __esm({
  "src/typescript-language-features/src/languageFeatures/util/dependentRegistration.ts"() {
    ...
    Condition = class extends Disposable {
      ...
      _onDidChange = this._register(new EventEmitter());
...
function fromProtocolCallHierarchyItem(item) {
  ...
  const name = useFileName ? path6.basename(item.file) : item.name;
  const detail = useFileName ? workspace.asRelativePath(path6.dirname(item.file)) : item.containerName ?? "";
...
var path6, TypeScriptCallHierarchySupport;
...
var init_baseCodeLensProvider = __esm({
  "src/typescript-language-features/src/languageFeatures/codeLens/baseCodeLensProvider.ts"() {
    ...
    TypeScriptBaseCodeLensProvider = class extends Disposable {
      ...
      changeEmitter = this._register(new EventEmitter());
      ...
      async provideCodeLenses(document2, token) {
        ...
        response.body?.childItems?.forEach((item) => this.walkNavTree(document2, item, void 0, referenceableSpans));
      ...
      walkNavTree(document2, item, parent, results) {
        ...
        item.childItems?.forEach((child) => this.walkNavTree(document2, child, item, results));
      }
    };
  }
});
...
var init_callbackMap = __esm({
  "src/typescript-language-features/src/tsServer/callbackMap.ts"() {
    ...
    CallbackMap = class {
      ...
      _asyncCallbacks = /* @__PURE__ */ new Map();
      destroy(cause) {
  ...
  "src/typescript-language-features/src/tsServer/serverError.ts"() {
    ...
    TypeScriptServerError = class _TypeScriptServerError extends Error {
      ...
      static create(serverId, version, response) {
        ...
        return new _TypeScriptServerError(serverId, version, response, parsedResult?.message, parsedResult?.stack, parsedResult?.sanitizedStack);
      }
      get serverErrorText() {
...
var SingleTsServer, RequestRouter, GetErrRoutingTsServer, SyntaxRoutingTsServer, RequestState;
var init_server = __esm({
  "src/typescript-language-features/src/tsServer/server.ts"() {
    ...
    init_dispose();
    init_protocol_const();
    SingleTsServer = class _SingleTsServer extends Disposable {
      ...
      _onEvent = this._register(new EventEmitter());
      onEvent = this._onEvent.event;
      _onExit = this._register(new EventEmitter());
      onExit = this._onExit.event;
      _onError = this._register(new EventEmitter());
      ...
      tryCancelRequest(request, command) {
        ...
        try {
          ...
          const callback2 = this.fetchCallback(seq);
          callback2?.onSuccess(new ServerResponse.Cancelled(`Cancelled request ${seq} - ${command}`));
        }
      }
      ...
      static fenceCommands = /* @__PURE__ */ new Set(["change", "close", "open", "updateOpen"]);
    ...
    RequestRouter = class _RequestRouter {
      constructor(servers, delegate) {
        this.servers = servers;
        this.delegate = delegate;
      }
      static sharedCommands = /* @__PURE__ */ new Set([
        "change",
        "close",
        "open",
        "updateOpen",
    ...
    GetErrRoutingTsServer = class _GetErrRoutingTsServer extends Disposable {
      static diagnosticEvents = /* @__PURE__ */ new Set([
    ...
    SyntaxRoutingTsServer = class _SyntaxRoutingTsServer extends Disposable {
      /**
       * Commands that should always be run on the syntax server.
       */
      static syntaxAlwaysCommands = /* @__PURE__ */ new Set([
        "navtree",
        "getOutliningSpans",
        "jsxClosingTag",
        "selectionRange",
       ...
       */
      static semanticCommands = /* @__PURE__ */ new Set([
        "geterr",
        "geterrForProject",
        "projectInfo",
        "configurePlugin"
       ...
       */
      static syntaxAllowedCommands = /* @__PURE__ */ new Set([
        "completions",
  ...
  "src/typescript-language-features/src/languageFeatures/codeLens/implementationsCodeLens.ts"() {
    ...
    TypeScriptImplementationsCodeLensProvider = class extends TypeScriptBaseCodeLensProvider {
      constructor(client, _cachedResponse, language) {
        ...
        this._register(
          workspace.onDidChangeConfiguration((evt) => {
            if (evt.affectsConfiguration(`${language.id}.implementationsCodeLens.showOnInterfaceMethods`) || evt.affectsConfiguration(`${language.id}.implementationsCodeLens.showOnAllClassMethods`)) {
      ...
      extractSymbol(document2, item, parent) {
        const cfg = workspace.getConfiguration(this.language.id);
        if (item.kind === Kind.interface) {
          return getSymbolRange(document2, item);
        }
        if ((item.kind === Kind.class || item.kind === Kind.method || item.kind === Kind.memberVariable || item.kind === Kind.memberGetAccessor || item.kind === Kind.memberSetAccessor) && /\babstract\b/.test(item.kindModifiers ?? "")) {
          return getSymbolRange(document2, item);
        }
        if (item.kind === Kind.method && parent?.kind === Kind.interface && cfg.get("implementationsCodeLens.showOnInterfaceMethods", false)) {
          return getSymbolRange(document2, item);
        }
        if (item.kind === Kind.method && parent?.kind === Kind.class && cfg.get("implementationsCodeLens.showOnAllClassMethods", false)) {
...
function getEditForCodeAction(client, action) {
  return action.changes?.length ? WorkspaceEdit2.fromFileCodeEdits(client, action.changes) : void 0;
}
...
var MyCompletionItem, CompletionAcceptedCommand, ApplyCompletionCommand, ApplyCompletionCodeActionCommand, CompletionConfiguration, TypeScriptCompletionItemProvider;
var init_completions = __esm({
  "src/typescript-language-features/src/languageFeatures/completions.ts"() {
    ...
    ApplyCompletionCommand = class _ApplyCompletionCommand {
      constructor(client) {
        this.client = client;
      }
      static ID = "_typescript.applyCompletionCommand";
      id = _ApplyCompletionCommand.ID;
      async execute(item) {
    ...
    ApplyCompletionCodeActionCommand = class _ApplyCompletionCodeActionCommand {
      constructor(client) {
        this.client = client;
      }
      static ID = "_typescript.applyCompletionCodeAction";
      id = _ApplyCompletionCodeActionCommand.ID;
    ...
    TypeScriptCompletionItemProvider = class {
      ...
      logCompletionsTelemetry(duration, response, includesPackageJsonImport, includesImportStatementCompletion) {
        this.telemetryReporter.logTelemetry("completions.execute", {
          ...
          flags: response?.type === "response" && typeof response.body?.flags === "number" ? String(response.body.flags) : void 0,
          count: String(response?.type === "response" && response.body ? response.body.entries.length : 0),
          updateGraphDurationMs: response?.type === "response" && typeof response.performanceData?.updateGraphDurationMs === "number" ? String(response.performanceData.updateGraphDurationMs) : void 0,
          createAutoImportProviderProgramDurationMs: response?.type === "response" && typeof response.performanceData?.createAutoImportProviderProgramDurationMs === "number" ? String(response.performanceData.createAutoImportProviderProgramDurationMs) : void 0,
      ...
      async resolveCompletionItem(item, token) {
        ...
        item.additionalTextEdits = resolved?.edits;
        return item;
      }
...
var CopyMetadata, TsPasteEdit, TsPendingPasteEdit, enabledSettingId, DocumentPasteProvider;
var init_copyPaste = __esm({
  "src/typescript-language-features/src/languageFeatures/copyPaste.ts"() {
    ...
    CopyMetadata = class _CopyMetadata {
      ...
      static parse(data) {
        try {
          ...
          const resource = Uri.parse(parsedData.resource);
          const ranges = parsedData.ranges.map((range) => new Range(range.start, range.end));
          const copyOperation = parsedData.copyOperation ? Promise.resolve(parsedData.copyOperation) : void 0;
          return new _CopyMetadata(resource, ranges, copyOperation);
        } catch (error) {
          return void 0;
        }
      }
    };
    TsPasteEdit = class _TsPasteEdit extends DocumentPasteEdit {
      static tryCreateFromResponse(client, response) {
        if (response.type !== "response" || !response.body?.edits.length) {
          return void 0;
        }
        const pasteEdit = new _TsPasteEdit();
        const additionalEdit = new WorkspaceEdit();
        for (const edit of response.body.edits) {
          additionalEdit.set(client.toResource(edit.fileName), edit.textChanges.map(TextEdit3.fromCodeEdit));
        }
        pasteEdit.additionalEdit = additionalEdit;
        return pasteEdit;
      }
      constructor() {
        super("", l10n.t("Paste with imports"), DocumentPasteProvider.kind);
        this.yieldTo = [
          DocumentDropOrPasteEditKind.Text.append("plain")
        ];
      }
    };
    TsPendingPasteEdit = class extends TsPasteEdit {
    ...
    DocumentPasteProvider = class _DocumentPasteProvider {
      constructor(_modeId, _client, fileConfigurationManager) {
        this._modeId = _modeId;
        this._client = _client;
        this.fileConfigurationManager = fileConfigurationManager;
      }
      static kind = DocumentDropOrPasteEditKind.TextUpdateImports.append("jsts");
      static metadataMimeType = "application/vnd.code.jsts.metadata";
      async prepareDocumentPaste(document2, ranges, dataTransfer, token) {
        if (!this.isEnabled(document2)) {
          return;
        }
        ...
        if (response) {
          ...
          dataTransfer.set(
            ...
            new DataTransferItem(new CopyMetadata(document2.uri, ranges, void 0))
          );
        } else {
          dataTransfer.set(
            _DocumentPasteProvider.metadataMimeType,
            new DataTransferItem(new CopyMetadata(document2.uri, ranges, copyRequest))
          );
        }
      }
      async provideDocumentPasteEdits(document2, ranges, dataTransfer, _context, token) {
        ...
        if (copiedFrom?.file === file2) {
          return;
        }
        const pasteCts = new import_vscode_languageserver_protocol5.CancellationTokenSource();
      ...
      async extractMetadata(dataTransfer, token) {
        const metadata = await dataTransfer.get(_DocumentPasteProvider.metadataMimeType)?.value;
        if (token.isCancellationRequested) {
          return void 0;
        }
...
function register10(client, commandManager) {
  function updateContext(overrideValue) {
    commands.executeCommand("setContext", FileReferencesCommand.context, overrideValue ?? client.apiVersion.gte(FileReferencesCommand.minVersion));
  }
  updateContext();
  commandManager.register(new FileReferencesCommand(client));
  return Disposable4.from(
    client.onTsServerStarted(() => updateContext()),
    new Disposable4(() => updateContext(false))
  );
}
var FileReferencesCommand;
var init_fileReferences = __esm({
  "src/typescript-language-features/src/languageFeatures/fileReferences.ts"() {
    ...
    init_api2();
    init_typeConverters();
    FileReferencesCommand = class _FileReferencesCommand {
      constructor(client) {
        this.client = client;
      }
      static context = "tsSupportsFileReferences";
      static minVersion = API.v420;
      ...
      async execute(resource) {
        ...
        return await window.withProgress({
          ...
          try {
            ...
            await config3.update("preferredLocation", existingSetting?.workspaceFolderValue ?? existingSetting?.workspaceValue);
          }
        });
      }
    };
...
async function buildIndividualFixes(fixes, edit, client, file2, diagnostics, token) {
  for (const diagnostic of diagnostics) {
    for (const { codes, fixName } of fixes) {
      ...
      const fix = response.body?.find((fix2) => fix2.fixName === fixName);
      if (fix) {
...
var SourceAction, SourceFixAll, SourceRemoveUnused, SourceAddMissingImports, TypeScriptAutoFixProvider;
var init_fixAll = __esm({
  "src/typescript-language-features/src/languageFeatures/fixAll.ts"() {
    ...
    SourceFixAll = class _SourceFixAll extends SourceAction {
      static kind = CodeActionKind.SourceFixAll.append("ts");
      constructor() {
    ...
    SourceRemoveUnused = class _SourceRemoveUnused extends SourceAction {
      static kind = CodeActionKind.Source.append("removeUnused").append("ts");
      constructor() {
    ...
    SourceAddMissingImports = class _SourceAddMissingImports extends SourceAction {
      static kind = CodeActionKind.Source.append("addMissingImports").append("ts");
      constructor() {
    ...
    TypeScriptAutoFixProvider = class _TypeScriptAutoFixProvider {
...
var init_folding = __esm({
  "src/typescript-language-features/src/languageFeatures/folding.ts"() {
    ...
    init_typeConverters();
    init_arrays();
    TypeScriptFoldingProvider = class _TypeScriptFoldingProvider {
      constructor(client) {
        this.client = client;
      }
  ...
  "src/typescript-language-features/src/languageFeatures/formatting.ts"() {
    ...
    TypeScriptFormattingProvider = class {
      ...
      async provideDocumentRangeFormattingEdits(document2, range, options, token) {
        ...
        await this.fileConfigurationManager.ensureConfigurationOptions(document2, options, token);
...
var init_hover = __esm({
  "src/typescript-language-features/src/languageFeatures/hover.ts"() {
    ...
    TypeScriptHoverProvider = class {
      ...
      lastHoverAndLevel;
      async provideHover(document2, position, token, context) {
        const filepath = this.client.toOpenTsFilePath(document2);
        if (!filepath) {
          return void 0;
        }
        ...
        const contents = this.getContents(document2.uri, response.body, response._serverType);
...
var init_inlayHints = __esm({
  "src/typescript-language-features/src/languageFeatures/inlayHints.ts"() {
    ...
    TypeScriptInlayHintsProvider = class extends Disposable {
      ...
      _onDidChangeInlayHints = this._register(new EventEmitter());
...
function register19(selector, client, commandManager, fileConfigurationManager, telemetryReporter) {
  const disposables = [];
...
var organizeImportsCommand, sortImportsCommand, removeUnusedImportsCommand, DidOrganizeImportsCommand, ImportCodeAction, ImportsCodeActionProvider;
var init_organizeImports = __esm({
  "src/typescript-language-features/src/languageFeatures/organizeImports.ts"() {
    ...
    DidOrganizeImportsCommand = class _DidOrganizeImportsCommand {
      constructor(telemetryReporter) {
        this.telemetryReporter = telemetryReporter;
      }
      static ID = "_typescript.didOrganizeImports";
      id = _DidOrganizeImportsCommand.ID;
      async execute() {
...
async function findEditScope(client, document2, edits) {
  ...
  return new Range(start, expandEnd?.end ?? end);
}
var EditorChatFollowUp, CompositeCommand;
var init_copilot = __esm({
  "src/typescript-language-features/src/languageFeatures/util/copilot.ts"() {
    ...
    CompositeCommand = class _CompositeCommand {
      static ID = "_typescript.compositeCommand";
      id = _CompositeCommand.ID;
...
function register20(selector, client, fileConfigurationManager, commandManager, diagnosticsManager, telemetryReporter) {
  return conditionalRegistration([
    requireSomeCapability(client, 2 /* Semantic */)
  ], () => {
...
var ApplyCodeActionCommand, ApplyFixAllCodeAction, DiagnosticsSet, VsCodeCodeAction, VsCodeFixAllCodeAction, CodeActionSet, SupportedCodeActionProvider, TypeScriptQuickFixProvider, fixAllErrorCodes, preferredFixes;
var init_quickFix = __esm({
  "src/typescript-language-features/src/languageFeatures/quickFix.ts"() {
    ...
    init_copilot();
    init_dependentRegistration();
    ApplyCodeActionCommand = class _ApplyCodeActionCommand {
    ...
    ApplyFixAllCodeAction = class _ApplyFixAllCodeAction {
      constructor(client, telemetryReporter) {
        this.client = client;
        this.telemetryReporter = telemetryReporter;
      }
      static ID = "_typescript.applyFixAllCodeAction";
      id = _ApplyFixAllCodeAction.ID;
      async execute(args) {
    ...
    CodeActionSet = class {
      _actions = /* @__PURE__ */ new Set();
      _fixAllActions = /* @__PURE__ */ new Map();
      _aiActions = /* @__PURE__ */ new Set();
      *values() {
        yield* this._actions;
    ...
    SupportedCodeActionProvider = class {
      ...
      fixableDiagnosticCodes = new Lazy(() => {
    ...
    TypeScriptQuickFixProvider = class _TypeScriptQuickFixProvider {
      ...
      getFixesForTsCodeAction(document2, diagnostic, action) {
        ...
        if (copilot?.isActive) {
          ...
          if (action.fixName === classIncorrectlyImplementsInterface) {
            title = l10n.t("{0} with AI", action.description);
            message = l10n.t("Implement the stubbed-out class members for {0} with a useful implementation.", document2.getText(diagnostic.range));
            ...
            title = l10n.t(`Implement missing function declaration '{0}' using AI`, document2.getText(diagnostic.range));
            message = l10n.t(`Provide a reasonable implementation of the function {0} given its type and the context it's called in.`, document2.getText(diagnostic.range));
            expand = { kind: "code-action", action };
          } else if (action.fixName === inferFromUsage) {
            const inferFromBody = new VsCodeCodeAction(action, l10n.t("Infer types using AI"), CodeActionKind.QuickFix);
            ...
            inferFromBody.command = {
              ...
              arguments: [{
                message: l10n.t("Add types to this code. Add separate interfaces when possible. Do not change the code except for adding types."),
            ...
            title = l10n.t("Add meaningful parameter name with AI");
            message = l10n.t(`Rename the parameter {0} with a more meaningful name.`, newText);
            expand = {
          ...
          if (expand && message !== void 0) {
            ...
            aiCodeAction.edit?.insert(document2.uri, diagnostic.range.start, "");
...
function register21(selector, client, cachedNavTree, formattingOptionsManager, commandManager, telemetryReporter) {
  return conditionalRegistration([
    requireSomeCapability(client, 2 /* Semantic */)
  ], () => {
    return languages.registerCodeActionsProvider(
...
var path7, import_vscode_uri9, DidApplyRefactoringCommand, SelectRefactorCommand, MoveToFileRefactorCommand, Extract_Function, Extract_Constant, Extract_Type, Extract_Interface, Move_File, Move_NewFile, Rewrite_Import, Rewrite_Export, Rewrite_Arrow_Braces, Rewrite_Parameters_ToDestructured, Rewrite_Property_GenerateAccessors, allKnownCodeActionKinds, InlinedCodeAction, MoveToFileCodeAction, SelectCodeAction, TypeScriptRefactorProvider;
var init_refactor = __esm({
  "src/typescript-language-features/src/languageFeatures/refactor.ts"() {
    ...
    init_dependentRegistration();
    init_share();
    DidApplyRefactoringCommand = class _DidApplyRefactoringCommand {
      constructor(telemetryReporter) {
        this.telemetryReporter = telemetryReporter;
      }
      static ID = "_typescript.didApplyRefactoring";
      id = _DidApplyRefactoringCommand.ID;
      async execute(args) {
    ...
    SelectRefactorCommand = class _SelectRefactorCommand {
      constructor(client) {
        this.client = client;
      }
      static ID = "_typescript.selectRefactoring";
      id = _SelectRefactorCommand.ID;
      async execute(args) {
    ...
    MoveToFileRefactorCommand = class _MoveToFileRefactorCommand {
      ...
      async getTargetFile(document2, file2, range) {
          ...
          const destinationItems = body.files.map((file3) => {
            ...
            if (workspaceFolder) {
              if (uri.scheme === Schemes.file) {
                description2 = path7.relative(workspaceFolder.uri.fsPath, parentDir.fsPath);
              } else {
                description2 = path7.posix.relative(workspaceFolder.uri.path, parentDir.path);
              }
              if (relativeQuery) {
                const convertRelativePath = (str) => {
                  return !str.startsWith("../") ? `./${str}` : str;
                };
                const relativePath = convertRelativePath(path7.relative(path7.dirname(document2.uri.fsPath), uri.fsPath));
            ...
            return {
              ...
              description: relativeQuery ? description2 : path7.join(description2, filename)
            };
          });
          quickPick.items = [
        ...
        if (picked === selectExistingFileItem) {
          ...
          return picked2?.length ? this.client.toTsFilePath(picked2[0]) : void 0;
    ...
    TypeScriptRefactorProvider = class _TypeScriptRefactorProvider {
      ...
      static _declarationKinds = /* @__PURE__ */ new Set([
        Kind.module,
        Kind.class,
        Kind.interface,
        Kind.function,
      ...
      *convertApplicableRefactors(document2, context, refactors, rangeOrSelection) {
      ...
      static isPreferred(action, allActions) {
        if (Extract_Constant.matches(action)) {
          const getScope = (name) => {
            const scope2 = name.match(/scope_(\d)/)?.[1];
...
function register22(selector, client) {
  return conditionalRegistration([
    requireSomeCapability(client, 1 /* EnhancedSyntax */, 2 /* Semantic */)
  ], () => {
...
function register23(selector, language, client, fileConfigurationManager) {
  return conditionalRegistration([
    requireSomeCapability(client, 2 /* Semantic */)
  ], () => {
...
var path8, TypeScriptRenameProvider;
  ...
  "src/typescript-language-features/src/languageFeatures/rename.ts"() {
    ...
    TypeScriptRenameProvider = class {
      ...
      async renameFile(fileToRename, fullDisplayName, newName, token) {
        if (!path8.extname(newName)) {
          newName += path8.extname(fileToRename);
        } else if (path8.extname(newName) === path8.extname(fullDisplayName)) {
          newName = newName.slice(0, newName.length - path8.extname(newName).length) + path8.extname(fileToRename);
        }
        const dirname5 = path8.dirname(fileToRename);
        const newFilePath = path8.join(dirname5, newName);
        const args = {
          file: fileToRename,
...
function register24(selector, client) {
  return conditionalRegistration([
    requireSomeCapability(client, 2 /* Semantic */)
  ], () => {
...
function register27(client, commandManager) {
  function updateContext(overrideValue) {
    commands.executeCommand("setContext", SourceDefinitionCommand.context, overrideValue ?? client.apiVersion.gte(SourceDefinitionCommand.minVersion));
  }
  updateContext();
...
var init_sourceDefinition = __esm({
  "src/typescript-language-features/src/languageFeatures/sourceDefinition.ts"() {
    ...
    init_api2();
    init_typeConverters();
    SourceDefinitionCommand = class _SourceDefinitionCommand {
      constructor(client) {
        this.client = client;
      }
...
function register28(selector, language, client) {
  return conditionalRegistration([
...
function register29(selector, client) {
  return conditionalRegistration([
    requireSomeCapability(client, 1 /* EnhancedSyntax */, 2 /* Semantic */)
  ], () => {
...
var init_logLevelMonitor = __esm({
  "src/typescript-language-features/src/logging/logLevelMonitor.ts"() {
    ...
    init_configuration2();
    init_dispose();
    LogLevelMonitor = class _LogLevelMonitor extends Disposable {
      constructor(context) {
        super();
      ...
      static logLevelConfigKey = "typescript.tsserver.log";
  ...
  "src/typescript-language-features/src/tsServer/bufferSyncSupport.ts"() {
    ...
    SyncedBuffer = class {
      ...
      getProjectRootPath(resource) {
        ...
        if (!workspaceRoot && workspace.workspaceFolders) {
          for (const root of Array.from(workspace.workspaceFolders).sort((a, b) => a.uri.path.length - b.uri.path.length)) {
        ...
        if (workspaceRoot) {
          ...
          return tsRoot?.startsWith(inMemoryResourcePrefix) ? void 0 : tsRoot;
        }
    ...
    GetErrRequest = class _GetErrRequest {
      ...
      _done = false;
      _token = new import_vscode_languageserver_protocol5.CancellationTokenSource();
    ...
    BufferSyncSupport = class extends Disposable {
      ...
      _onDelete = this._register(new EventEmitter());
      onDelete = this._onDelete.event;
      _onWillChange = this._register(new EventEmitter());
...
var init_nodeManager = __esm({
  "src/typescript-language-features/src/tsServer/nodeManager.ts"() {
    ...
    NodeVersionManager = class extends Disposable {
      ...
      _currentVersion;
      _onDidPickNewVersion = this._register(new EventEmitter());
...
var path9, TypeScriptPluginPathsProvider;
  ...
  "src/typescript-language-features/src/tsServer/pluginPathsProvider.ts"() {
    ...
    TypeScriptPluginPathsProvider = class {
      ...
      resolvePluginPath(pluginPath) {
        ...
        return (workspace.workspaceFolders || []).map((workspaceFolder) => path9.join(workspaceFolder.uri.fsPath, pluginPath));
      }
    };
  }
});
...
var init_spawner = __esm({
  "src/typescript-language-features/src/tsServer/spawner.ts"() {
    ...
    init_server();
    init_lazy();
    TypeScriptServerSpawner = class _TypeScriptServerSpawner {
      ...
      static tsServerLogOutputChannel = new Lazy(() => {
      ...
      getCompositeServerType(version, capabilities, configuration) {
        ...
        switch (configuration.useSyntaxServer) {
          ...
          case 0 /* Never */:
            return 0 /* Single */;
          case 2 /* Auto */:
            return version.apiVersion?.gte(API.v400) ? 2 /* DynamicSeparateSyntax */ : 1 /* SeparateSyntax */;
        }
      }
      ...
      getTsServerArgs(kind, configuration, currentVersion, apiVersion, pluginManager, cancellationPipeName) {
        ...
        if (_TypeScriptServerSpawner.isLoggingEnabled(configuration)) {
          if (isWeb()) {
            ...
            tsServerLog = { type: "output", output: _TypeScriptServerSpawner.tsServerLogOutputChannel.value };
          } else {
  ...
  "src/typescript-language-features/src/tsServer/versionManager.ts"() {
    ...
    TypeScriptVersionManager = class extends Disposable {
      ...
      getNativePreviewPickItem() {
        const nativePreviewExtension = extensions.getExtension(tsNativeExtensionId);
        if (!nativePreviewExtension) {
          return void 0;
        }
        const tsConfig = workspace.getConfiguration("typescript");
        const isUsingTsgo = tsConfig.get("experimental.useTsgo", false);
        return {
          label: (isUsingTsgo ? "\u2022 " : "") + l10n.t("Use TypeScript Native Preview (Experimental)"),
          description: nativePreviewExtension.packageJSON.version,
          run: async () => {
            await commands.executeCommand("typescript.native-preview.enable");
          }
        };
      }
...
var import_os, path10, ServerState, emptyAuthority, inMemoryResourcePrefix, TypeScriptServiceClient, ServerInitializingIndicator;
  ...
  "src/typescript-language-features/src/typescriptServiceClient.ts"() {
    ...
    ((ServerState2) => {
      ...
      class Running {
        ...
        type = 1 /* Running */;
        toCancelOnResourceChange = /* @__PURE__ */ new Set();
    ...
    TypeScriptServiceClient = class extends Disposable {
      constructor(context, onCaseInsensitiveFileSystem2, services, allModeIds) {
        ...
        this.diagnosticsManager = this._register(new DiagnosticsManager("typescript", this._configuration, this.telemetryReporter, onCaseInsensitiveFileSystem2));
      ...
      _onDidChangeCapabilities = this._register(new EventEmitter());
      ...
      _onTsServerStarted = this._register(new EventEmitter());
      onTsServerStarted = this._onTsServerStarted.event;
      _onDiagnosticsReceived = this._register(new EventEmitter());
      onDiagnosticsReceived = this._onDiagnosticsReceived.event;
      _onConfigDiagnosticsReceived = this._register(new EventEmitter());
      onConfigDiagnosticsReceived = this._onConfigDiagnosticsReceived.event;
      _onResendModelsRequested = this._register(new EventEmitter());
      onResendModelsRequested = this._onResendModelsRequested.event;
      _onProjectLanguageServiceStateChanged = this._register(new EventEmitter());
      onProjectLanguageServiceStateChanged = this._onProjectLanguageServiceStateChanged.event;
      _onDidBeginInstallTypings = this._register(new EventEmitter());
      onDidBeginInstallTypings = this._onDidBeginInstallTypings.event;
      _onDidEndInstallTypings = this._register(new EventEmitter());
      onDidEndInstallTypings = this._onDidEndInstallTypings.event;
      _onTypesInstallerInitializationFailed = this._register(new EventEmitter());
      onTypesInstallerInitializationFailed = this._onTypesInstallerInitializationFailed.event;
      _onSurveyReady = this._register(new EventEmitter());
      ...
      toOpenTsFilePath(document2, options = {}) {
        const uri = document2 instanceof Uri ? document2 : document2.uri;
      ...
      getWorkspaceRootForResource(resource) {
        ...
        return workspace.getWorkspaceFolder(resource)?.uri;
      }
      execute(command, args, token, config3) {
        let executions;
        if (config3?.cancelOnResourceChange) {
      ...
      dispatchEvent(event) {
        switch (event.event) {
          ...
          case "createDirectoryWatcher" /* createDirectoryWatcher */: {
            ...
            if (process.platform === "darwin" && fpath === path10.join((0, import_os.homedir)(), "Library")) {
              return;
            }
      ...
      addWatchEvent(id, eventType, path15) {
        ...
        const removeEvent = (typeOfEventToRemove) => {
          if (event?.[typeOfEventToRemove]?.delete(path15) && event[typeOfEventToRemove].size === 0) {
    ...
    ServerInitializingIndicator = class extends Disposable {
      ...
      startedLoadingFile(fileName, task) {
        if (!this._task) {
          window.withProgress({
            location: 10 /* Window */,
            title: l10n.t("Analyzing '{0}' and its dependencies", path10.basename(fileName))
          }, () => task);
        }
      }
  ...
  "src/typescript-language-features/src/ui/intellisenseStatus.ts"() {
    ...
    ((IntellisenseState2) => {
      ...
      class Pending {
        ...
        type = 1 /* Pending */;
        cancellation = new import_vscode_languageserver_protocol5.CancellationTokenSource();
      }
...
var init_typingsStatus = __esm({
  "src/typescript-language-features/src/ui/typingsStatus.ts"() {
    ...
    TypingsStatus = class extends Disposable {
      _acquiringTypings = /* @__PURE__ */ new Map();
      _client;
      constructor(client) {
        super();
        this._client = client;
...
function register30(client, fileConfigurationManager, handles) {
  return conditionalRegistration([
    requireSomeCapability(client, 2 /* Semantic */)
  ], () => {
...
var path11, updateImportsOnFileMoveName, UpdateImportsOnFileRenameHandler;
var init_updatePathsOnRename = __esm({
  "src/typescript-language-features/src/languageFeatures/updatePathsOnRename.ts"() {
    ...
    UpdateImportsOnFileRenameHandler = class extends Disposable {
      ...
      _delayer = new Delayer(50);
      _pendingRenames = /* @__PURE__ */ new Set();
      async flushRenames() {
      ...
      async promptUser(newResources) {
        ...
        const response = await window.showInformationMessage(
          newResources.length === 1 ? l10n.t("Update imports for '{0}'?", path11.basename(newResources[0].fsPath)) : this.getConfirmMessage(l10n.t("Update imports for the following {0} files?", newResources.length), newResources),
          {
            modal: true
          },
          rejectItem,
      ...
      getConfirmMessage(start, resourcesToConfirm) {
        ...
        const paths = [start];
        paths.push("");
        paths.push(...resourcesToConfirm.slice(0, MAX_CONFIRM_FILES).map((r) => path11.basename(r.fsPath)));
...
function register31(client, modeIds) {
    ...
    TypeScriptWorkspaceSymbolProvider = class _TypeScriptWorkspaceSymbolProvider {
      ...
      async toOpenedFiledPath(document2) {
        if (document2.uri.scheme === git) {
          try {
            const path15 = Uri.file(JSON.parse(document2.uri.query)?.path);
...
var init_typeScriptServiceClientHost = __esm({
  "src/typescript-language-features/src/typeScriptServiceClientHost.ts"() {
    ...
    TypeScriptServiceClientHost = class extends Disposable {
      client;
      languages = [];
      languagePerId = /* @__PURE__ */ new Map();
      typingsStatus;
      ...
      async diagnosticsReceived(kind, resource, diagnostics, spans) {
        ...
        if (language) {
          language.diagnosticsReceived(
            ...
            spans?.map((span) => Range4.fromTextSpan(span))
          );
        }
      }
...
var fs4, NodeRequestCanceller, nodeRequestCancellerFactory;
  ...
  "src/typescript-language-features/src/tsServer/cancellation.electron.ts"() {
    ...
    NodeRequestCanceller = class {
      ...
      tryCancelOngoingRequest(seq) {
        ...
        try {
          fs4.writeFileSync(this.cancellationPipeName + seq, "");
        } catch {
        }
        return true;
      }
...
var fs5, path12, NodeLogDirectoryProvider;
  ...
  "src/typescript-language-features/src/tsServer/logDirectoryProvider.electron.ts"() {
    ...
    NodeLogDirectoryProvider = class {
      ...
      getNewLogDirectory() {
        ...
        if (root) {
          try {
            return Uri.file(fs5.mkdtempSync(path12.join(root, `tsserver-log-`)));
          } catch (e) {
            return void 0;
          }
        }
      ...
      logDirectory = new Lazy(() => {
        try {
          const path15 = this.context.logPath;
          if (!fs5.existsSync(path15)) {
            fs5.mkdirSync(path15);
          }
  ...
  "src/typescript-language-features/src/tsServer/plugins.ts"() {
    ...
    ((TypeScriptServerPlugin2) => {
      function equals3(a, b) {
        return a.uri?.toString() === b.uri?.toString() && a.name === b.name && a.enableForWorkspaceTypeScriptVersions === b.enableForWorkspaceTypeScriptVersions && equals(a.languages, b.languages);
      }
    ...
    PluginManager = class extends Disposable {
      _pluginConfigurations = /* @__PURE__ */ new Map();
      _plugins;
      constructor() {
        super();
      ...
      _onDidUpdatePlugins = this._register(new EventEmitter());
      onDidChangePlugins = this._onDidUpdatePlugins.event;
      _onDidUpdateConfig = this._register(new EventEmitter());
...
function generatePatchedEnv(env2, modulePath, hasExecPath) {
  ...
  newEnv["NODE_PATH"] = path13.join(modulePath, "..", "..", "..");
...
var child_process2, fs6, path13, defaultSize, contentLength, contentLengthSize, blank, backslashR, backslashN, ProtocolBuffer, Reader, IpcChildServerProcess, StdioChildServerProcess, ElectronServiceProcessFactory;
var init_serverProcess_electron = __esm({
  "src/typescript-language-features/src/tsServer/serverProcess.electron.ts"() {
    ...
    Reader = class extends Disposable {
      ...
      _onError = this._register(new EventEmitter());
      onError = this._onError.event;
      _onData = this._register(new EventEmitter());
    ...
    ElectronServiceProcessFactory = class {
      fork(version, args, kind, configuration, versionManager, nodeVersionManager, _tsserverLog) {
        ...
        if (!fs6.existsSync(tsServerPath)) {
        ...
        const childProcess = execPath ? child_process2.spawn(execPath, [...execArgv, tsServerPath, ...runtimeArgs], {
          windowsHide: true,
          cwd: void 0,
          env: env2
        }) : child_process2.fork(tsServerPath, runtimeArgs, {
          silent: true,
          cwd: void 0,
          env: env2,
          execArgv,
...
var fs7, path14, import_module, import_url, req, DiskTypeScriptVersionProvider;
    ...
    DiskTypeScriptVersionProvider = class _DiskTypeScriptVersionProvider {
      ...
      getContributedVersion(source, extensionId, pathToTs) {
        try {
          ...
          const serverPath = path14.join(path14.dirname(tsPath), "tsserver.js");
      ...
      loadVersionsFromSetting(source, tsdkPathSetting) {
        if (path14.isAbsolute(tsdkPathSetting)) {
          const serverPath = path14.join(tsdkPathSetting, "tsserver.js");
          return [
        ...
        if (workspacePath !== void 0) {
          const serverPath = path14.join(workspacePath, "tsserver.js");
          return [
            new TypeScriptVersion(
              source,
              serverPath,
      ...
      get localNodeModulesVersions() {
        return this.loadTypeScriptVersionsFromPath("node-modules" /* NodeModules */, path14.join("node_modules", "typescript", "lib")).filter((x) => x.isValid);
      }
      loadTypeScriptVersionsFromPath(source, relativePath) {
        ...
        for (const root of workspace.workspaceFolders) {
          ...
          if (workspace.workspaceFolders.length > 1) {
            label = path14.join(root.name, relativePath);
          }
          const serverPath = path14.join(root.uri.fsPath, relativePath, "tsserver.js");
      ...
      static getTypeScriptVersion(serverPath) {
        ...
        const p = serverPath.split(path14.sep);
        if (p.length <= 2) {
          return void 0;
        }
        const p2 = p.slice(0, -2);
        const modulePath = p2.join(path14.sep);
        let fileName = path14.join(modulePath, "package.json");
        if (!fs7.existsSync(fileName)) {
          if (path14.basename(modulePath) === "built") {
            fileName = path14.join(modulePath, "..", "package.json");
          }
        }
        if (!fs7.existsSync(fileName)) {
          return void 0;
        }
        const contents = fs7.readFileSync(fileName).toString();
        let desc;
        try {
...
var init_activeJsTsEditorTracker = __esm({
  "src/typescript-language-features/src/ui/activeJsTsEditorTracker.ts"() {
    ...
    ActiveJsTsEditorTracker = class extends Disposable {
      _activeJsTsEditor;
      _onDidChangeActiveJsTsEditor = this._register(new EventEmitter());
...
var LspInvariantConverter = class {
  convertTextEdit = (edit) => {
    return {
      range: this.convertRangeToLsp(edit.range),
      newText: edit.newText
    };
  };
  convertPositionToLsp = (pos) => {
    return {
      line: pos.line,
      character: pos.character
    };
  };
  convertRangeToLsp = (range) => {
    return {
      start: range.start,
      end: range.end
    };
  };
  convertPositionFromLsp = (position) => Position.of(position);
  convertRangeFromLsp = (range) => Range.of(range);
};
var TSLspConverter = class extends LspInvariantConverter {
  ...
  convertWorkspaceEdit = (edit) => {
    const resouceOpKinds = this.clientCapabilities.workspace?.workspaceEdit?.resourceOperations ?? [];
    const docChanges = [];
      ...
      if (entry._type === 1 /* File */) {
        ...
        if (!entry.from) {
          if (
            ...
            !entry.options?.ignoreIfExists && !resouceOpKinds.includes(lsp8.ResourceOperationKind.Create)
          ) {
  ...
  convertCompletionItem = (item, data) => {
    ...
    const insertText = isSnippet ? item.insertText.value : item.insertText ?? item.textEdit?.newText;
    let textEdit = void 0;
    if (item.range) {
      ...
      } else if (this.clientCapabilities.textDocument?.completion?.completionItem?.insertReplaceSupport) {
        textEdit = {
  ...
  convertLocationLinkToLocation = (location) => {
    return {
  ...
  convertDiagnosticFromLsp = (diagnostic) => {
  ...
  convertDiagnosticToLsp = (diagnostic) => {
  ...
  convertSymbol = (symbol) => {
    if ("range" in symbol) {
      const result = {
        ...
        children: symbol.children && this.clientCapabilities.textDocument?.documentSymbol?.hierarchicalDocumentSymbolSupport ? symbol.children.map(this.convertSymbol) : void 0
      };
      return result;
    } else {
      const result = {
  ...
  convertSignatureInfoFromLsp = (info) => {
  ...
  convertSignatureInfoToLsp = (info) => {
    return {
      label: info.label,
  ...
  convertCallHierarcgyItemToLsp = (item, data) => {
    return {
  ...
  convertCallHierarcgyItemFromLsp = (item) => {
  ...
  convertSemanticTokens = (tokens) => {
    return { data: Array.from(tokens.data), resultId: tokens.resultId };
  };
  convertLinkedEditingRanges = (data) => {
    return {
...
var CodeActionCache = class extends Disposable {
  codeActionCache = this._register(
...
init_dispose2();
init_types();
var CompletionCache = class _CompletionCache extends Disposable {
  static id = "_vtsls.completionCacheCommand";
  ...
  completionItemCache = this._register(
    new RestrictedCache(12)
  );
  store(items, providerId) {
...
var TSCompletionFeature = class extends Disposable {
  ...
  async completion(doc, params, token) {
    ...
    if (params.context?.triggerKind === lsp10.CompletionTriggerKind.TriggerForIncompleteCompletions && this.lastCompleteResult) {
  ...
  getCompletionItemFuzzyScorer(itemsLen, position, wordRange, leadingLineContent) {
    ...
    let wordLow = "";
    return (item) => {
      const editStartColumn = item.range ? Range.isRange(item.range) ? item.range.start.character : item.range?.inserting.start.character : wordRange?.start.character ?? position.character;
...
__export(package_nls_exports, {
  ...
  "configuration.hover.maximumLength": () => configuration_hover_maximumLength,
  ...
  "configuration.implicitProjectConfig.strict": () => configuration_implicitProjectConfig_strict,
  ...
  "configuration.inlayHints": () => configuration_inlayHints,
  ...
  "configuration.preferences": () => configuration_preferences,
  "configuration.server": () => configuration_server,
  "configuration.suggest": () => configuration_suggest,
  ...
  "typescript.implementationsCodeLens.showOnAllClassMethods": () => typescript_implementationsCodeLens_showOnAllClassMethods,
  ...
  "typescript.problemMatchers.tsgo-watch.label": () => typescript_problemMatchers_tsgo_watch_label,
  ...
  "typescript.useTsgo": () => typescript_useTsgo,
...
var configuration_preferences = "Preferences";
var configuration_format = "Formatting";
var configuration_suggest = "Suggestions";
var configuration_inlayHints = "Inlay Hints";
var configuration_server = "TS Server";
...
var typescript_useTsgo = "Disables TypeScript and JavaScript language features to allow usage of the TypeScript Go experimental extension. Requires TypeScript Go to be installed and configured. Requires reloading extensions after changing this setting.";
...
var typescript_implementationsCodeLens_showOnAllClassMethods = "Enable/disable showing implementations CodeLens above all class methods instead of only on abstract methods.";
...
var typescript_problemMatchers_tsgo_watch_label = "TypeScript problems (watch mode)";
...
var configuration_implicitProjectConfig_strict = "Enable/disable [strict mode](https://www.typescriptlang.org/tsconfig#strict) in JavaScript and TypeScript files that are not part of a project. Existing `jsconfig.json` or `tsconfig.json` files override this setting.";
...
var typescript_suggest_enabled = "Enable/disable autocomplete suggestions.";
...
var configuration_hover_maximumLength = "The maximum number of characters in a hover. If the hover is longer than this, it will be truncated. Requires TypeScript 5.9+.";
...
function getDefaultConfig() {
  const contributed = Object.assign({}, ...contributes.configuration.map((c) => c.properties));
